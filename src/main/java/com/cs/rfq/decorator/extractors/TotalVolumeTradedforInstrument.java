...
public class TotalVolumeTradedforInstrument implements RfqMetadataExtractor {
    private long week;
    private long month;
    private long year;

    public TotalVolumeTradedforInstrument(){
    ...
    public Map<RfqMetadataFieldNames, Object> extractMetaData(Rfq rfq, SparkSession session, Dataset<Row> trades) {
        ...
        results.put(InstrumentVolumeTradedforpastWeek, volumeforWeek);
        results.put(InstrumentVolumeTradedforpastMonth, volumeforMonth);
        results.put(InstrumentVolumeTradedforpastYear, volumeforYear);
        return results;
    }
